...
func enter_state() -> void:
	print_debug("Player entered Jumping-state.")
func update_state(delta : float) -> void:
	_jumping()

func _jumping():
	actor.animator.play("player_jump") #We play the walking-animation, using the Actors animator.

func exit_state() -> void:
	print_debug("Player exit Jumping")

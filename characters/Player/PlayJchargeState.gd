class_name PlayJchargeState #Player Jump-Charge state
extends State
...
func enter_state() -> void:
	print_debug("Player entered Jump-Charge state.")
	
func update_state(delta : float) -> void:
	_jcharging()

func _jcharging():
	actor.animator.play("player_charge_jump") #We play the walking-animation, using the Actors animator.

func exit_state() -> void:
	print_debug("Player exit Jump-Charging")

...
func enter_state() -> void:
	print_debug("Player entered Attacking.")
func update_state(delta : float) -> void:
	_running()

func _running():
	actor.animator.play("player_attack") #We play the walking-animation, using the Actors animator.

func exit_state() -> void:
	print_debug("Player exit Attacking")
